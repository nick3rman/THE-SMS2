...
os.system("gem install lolcat")
os.system("clear")
os.system("toilet -f future NAME |lolcat")
name = str(input("who are you (ชื่อของคุณ): "))
os.system("clear")
def slowprint(s):
	for c in s + '\n':
		sys.stdout.write(c)
		sys.stdout.flush()
		time.sleep(1./10)
slowprint(" ผม ไม่ให้ เครดิต ใครทั้งนั้น รวมถึงผม")
os.system("toilet -f future SPAM-SMS |lolcat")
time.sleep(6)
os.system("clear")
os.system("toilet -f future "+str(name)+(" |lolcat"))
