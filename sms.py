#ห้ามเปลี่ยนเครดิตท่าเปลี่ยนะพ่องตายไม่ใช่สคริปมึงห้ามเปลี่ยนท่าเป็นของมึงมึงก็เปลี่ยนไปแต่นี้ไม่ใช่ของมึงใครเอ่ไปใช่ห้ามเปลี่ยนกูบอกแค่นั้น
...
import requests,json,time,threading
os.system("clear")
os.system("toilet -f mono12 Welcome |lolcat")
time.sleep(1)
os.system("clear")
os.system("toilet -f mono12 S P A M S M S |lolcat")
session = requests.Session()
print("##########################ห้ามเปลี่ยนเครดิต######################                                                           ")
print("                                                             ")
print("           เครดิตFB : sirapop'Pro tongpitak'Gramer                                   ")
print("           เครดิตผู้ดัดแปลงFB : ด.ช. เท็ม ช่องยูทูป LTEMX2                          ")
print("                                                            ")
print("#############################################################                                                           ")
number = input("\033[90m> \033[1;97mNUMBER: \033[1;92m")
print("complete ")
num = int(input("\033[90m> \033[1;97mnumber send: \033[1;92m"))
num = int("" + number)
class SMS():
...
os.system("clear")
print ("กำลังรัน....")
print("มึงจะเปลี่ยนเครดิตเพื่อสคริปก็ไม่ใช่ของมึง")
t = SMS()
def loop(num):
    for i in range(num):
        t.spamais(num)
...
loop(num)
#ห้ามเปลี่ยนเครดิตสคริปไม่ใช่ของมึงท่าเปลี่ยนกุจะปิดAPIทันทีกุบอกแค่นั้นใครใช่ห้ามเปลี่ยน
